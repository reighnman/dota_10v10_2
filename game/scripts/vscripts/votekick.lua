    ...
    if isInProgress then
      ...
      if victimId then
        ...
        if victimName then
          ...
          GameRules:SendCustomMessage("<B><font color='#FFFF00'>" .. PlayerResource:GetPlayerName(keys.playerid) .. " initiated votekick of <font color='#FF0000'>" .. victimName .. "</font></B>", -1, -1)
          GameRules:SendCustomMessage("<font color='#FFFF00'> If you wish to vote in favor of this kick, type <font color='#FF0000'>-vote <font color='#FFFF00'>in chat.", -1, -1)
...
function EndVote()
  ...
  if votePercent >= 75 then
    GameRules:SendCustomMessage("<B><font color='#FFFF00'> Voting <font color='#136207'>PASSED: " .. totalVotes .. "/%" .. votePercent, -1, -1)
    ...
    GameRules:SendCustomMessage("<B><font color='#FFFF00'> Vote kick FAILED: " .. totalVotes .. " / " .. votePercent .. "%", -1, -1)
  end
